 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ps(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function Pp(){return _i()==="http:"||_i()==="https:"}function _i(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kp(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Pp()||of()||"connection"in navigator)?navigator.onLine:!0}function Rp(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jt{constructor(e,t){this.shortDelay=e,this.longDelay=t,me(t>e,"Short delay should be less than long delay!"),this.isMobile=sf()||af()}get(){return kp()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fp(n,e){return Pe(n,"POST","/v1/accounts:delete",e)}async function On(n,e){return Pe(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zp(n,e={}){return Pe(n,"GET","/v2/passwordPolicy",De(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dm(n,e){const t=zo(n,"auth");if(t.isInitialized()){const r=t.getImmediate(),i=t.getOptions();if(Et(i,e??{}))return r;z(r,"already-initialized")}return t.initialize({options:e})}function hm(n,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(ce);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function fm(n,e,t){const s=ke(n);_(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const r=!1,i=ma(e),{host:o,port:a}=pm(e),c=a===null?"":`:${a}`,l={url:`${i}//${o}${c}/`},u=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:r})});if(!s._canInitEmulator){_(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),_(Et(l,s.config.emulator)&&Et(u,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=l,s.emulatorConfig=u,s.settings.appVerificationDisabledForTesting=!0,Un(o)?(Zh(`${i}//${o}${c}`),nf("Auth",!0)):mm()}function ma(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function pm(n){const e=ma(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",r=/^(\[[^\]]+\])(:|$)/.exec(s);if(r){const i=r[1];return{host:i,port:Ai(s.substr(i.length+1))}}else{const[i,o]=s.split(":");return{host:i,port:Ai(o)}}}function Ai(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function mm(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class or{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return ae("not implemented")}_getIdTokenResponse(e){return ae("not implemented")}_linkToIdToken(e,t){return ae("not implemented")}_getReauthenticationResolver(e){return ae("not implemented")}}async function gm(n,e){return Pe(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bm(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function wm(n){const e=Lt(Dt(n)).link,t=e?Lt(Dt(e)).deep_link_id:null,s=Lt(Dt(n)).deep_link_id;return(s?Lt(Dt(s)).link:null)||s||t||e||n}class ar{constructor(e){const t=Lt(Dt(e)),s=t.apiKey??null,r=t.oobCode??null,i=bm(t.mode??null);_(s&&r&&i,"argument-error"),this.apiKey=s,this.operation=i,this.code=r,this.continueUrl=t.continueUrl??null,this.languageCode=t.lang??null,this.tenantId=t.tenantId??null}static parseLink(e){const t=wm(e);try{return new ar(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _a(n,e,t=!1){if(W(n.app))return Promise.reject(de(n));const s="signIn",r=await ga(n,s,e),i=await Ye._fromIdTokenResponse(n,s,r);return t||await n._updateCurrentUser(i.user),i}async function Sm(n,e){return _a(ke(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ea(n){const e=ke(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Cm(n,e,t){if(W(n.app))return Promise.reject(de(n));const s=ke(n),o=await Rs(s,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Tm).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&Ea(n),c}),a=await Ye._fromIdTokenResponse(s,"signIn",o);return await s._updateCurrentUser(a.user),a}function Om(n,e,t){return W(n.app)?Promise.reject(de(n)):Sm(_e(n),It.credential(e,t)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&Ea(n),s})}function Nm(n,e,t,s){return _e(n).onIdTokenChanged(e,t,s)}function Lm(n,e,t){return _e(n).beforeAuthStateChanged(e,t)}function Dm(n,e,t,s){return _e(n).onAuthStateChanged(e,t,s)}function Pm(n){return _e(n).signOut()}const Dn="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cg(n,e={}){return Pe(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lg="__/auth/handler",Dg="emulator/auth/handler",Pg=encodeURIComponent("fac");async function Pi(n,e,t,s,r,i){_(n.config.authDomain,n,"auth-domain-config-required"),_(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:s,v:Xt,eventId:r};if(e instanceof cr){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",pf(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,f]of Object.entries({}))o[u]=f}if(e instanceof Zt){const u=e.getScopes().filter(f=>f!=="");u.length>0&&(o.scopes=u.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await n._getAppCheckToken(),l=c?`#${Pg}=${encodeURIComponent(c)}`:"";return`${kg(n)}?${Yt(a).slice(1)}${l}`}function kg({config:n}){return n.emulator?sr(n,Dg):`https://${n.authDomain}/${Lg}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Bg=5*60,Hg=Wo("authIdTokenMaxAge")||Bg;let Mi=null;const Vg=n=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>Hg)return;const r=t==null?void 0:t.token;Mi!==r&&(Mi=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function Fg(n=gp()){const e=zo(n,"auth");if(e.isInitialized())return e.getImmediate();const t=dm(n,{popupRedirectResolver:Mg,persistence:[zm,Mm,wa]}),s=Wo("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(s,location.origin);if(location.origin===i.origin){const o=Vg(i.toString());Lm(t,o,()=>o(t.currentUser)),Nm(t,a=>o(a))}}const r=Jh("auth");return r&&fm(t,`http://${r}`),t}function Wg(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}sm({loadJS(n){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",n),s.onload=e,s.onerror=r=>{const i=Z("internal-error");i.customData=r,t(i)},s.type="text/javascript",s.charset="UTF-8",Wg().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Ug("Browser");const jg={apiKey:"AIzaSyBABJUTpmf11FR96mfhpumXk5APDx22Xsk",authDomain:"zohue-auth.firebaseapp.com",projectId:"zohue-auth",storageBucket:"zohue-auth.firebasestorage.app",messagingSenderId:"438985606953",appId:"1:438985606953:web:b5cb8ca6e94d05097c1938",measurementId:"G-6QV1MNLQ0W"},qg=Go(jg),At=Fg(qg),Kg=()=>{const n=new oe;return Na(At,n)},zg=(n,e)=>Cm(At,n,e),Gg=(n,e)=>Om(At,n,e),Yg=async()=>{const n=new ie;try{const e=await Na(At,n);return console.log("Google 登入成功:",e.user),e}catch(e){throw console.error("Google 登入失敗:",e),e}},Ze=[{id:1,title:"初心",subtitle:"はじめ",volunteer:"林美玲",role:"英語教學志工",story:"第一次踏進偏鄉小學，看見孩子們渴望學習的眼神，我知道這就是我想做的事。",quote:"教育不是填滿水桶，而是點燃火焰。",image:"🌸",imageUrl:"https://picsum.photos/id/180/767/470",stats:{students:32,hours:128,years:2}},{id:2,title:"成長",subtitle:"せいちょう",volunteer:"陳志明",role:"程式設計導師",story:"從一個害羞的工程師，到能夠站在講台上分享知識，這段旅程改變了我。",quote:"在教學中，我們不只是老師，更是永遠的學生。",image:"🌿",imageUrl:"https://picsum.photos/id/160/767/470",stats:{students:45,hours:256,years:3}},{id:3,title:"感動",subtitle:"かんどう",volunteer:"王雅琪",role:"美術創作老師",story:"當學生第一次完成作品時的笑容，是我繼續前進的最大動力。",quote:"藝術讓孩子看見世界的美好，也看見自己的可能。",image:"🎨",imageUrl:"https://picsum.photos/id/184/767/470",stats:{students:28,hours:96,years:1}},{id:4,title:"堅持",subtitle:"けんじ",volunteer:"李建華",role:"數學輔導老師",story:"即使遇到挫折，看到學生進步的那一刻，所有的努力都值得了。",quote:"堅持不是因為看到希望才堅持，而是堅持了才看到希望。",image:"💪",imageUrl:"https://picsum.photos/id/188/767/470",stats:{students:38,hours:180,years:4}},{id:5,title:"希望",subtitle:"きぼう",volunteer:"張淑芬",role:"閱讀推廣志工",story:"每一本書都是一扇窗，讓孩子們看見更廣闊的世界。",quote:"閱讀是給孩子最好的禮物，知識是他們飛翔的翅膀。",image:"📚",imageUrl:"https://picsum.photos/id/24/767/470",stats:{students:52,hours:320,years:5}},{id:6,title:"傳承",subtitle:"でんしょう",volunteer:"劉永祥",role:"資深志工導師",story:"看著新志工們成長，就像看見自己當年的模樣，這份愛會一直傳下去。",quote:"最好的傳承不是給予，而是啟發他人也成為給予者。",image:"🌟",imageUrl:"https://picsum.photos/id/177/767/470",stats:{students:120,hours:500,years:8}}];let se=0,dt=!1,dr=!1,$i=0,Da=0,g={};function Xg(){const n=document.getElementById("lightbox");n&&(n.style.display="flex",setTimeout(()=>{n.classList.add("active")},10),window.storyWallInitialized||(Zg(),window.storyWallInitialized=!0))}function hr(){const n=document.getElementById("lightbox");if(!n)return;n.classList.add("closing"),n.classList.remove("active");const e=n.querySelector(".lightbox-content");e&&e.addEventListener("animationend",function t(){n.style.display="none",n.classList.remove("closing"),e.removeEventListener("animationend",t)})}function Jg(){g={chapterName:document.querySelector("#chapterName"),chapterSubtitle:document.querySelector("#chapterSubtitle"),volunteerImage:document.querySelector("#volunteerImage"),volunteerName:document.querySelector("#volunteerName"),volunteerRole:document.querySelector("#volunteerRole"),storyParagraph:document.querySelector("#storyParagraph"),storyQuote:document.querySelector("#storyQuote"),statStudents:document.querySelector("#statStudents"),statHours:document.querySelector("#statHours"),statYears:document.querySelector("#statYears"),pageCurrent:document.querySelector("#pageCurrent"),pageTotal:document.querySelector("#pageTotal"),scrollHint:document.querySelector("#scrollHint"),storyContent:document.querySelector("#storyContent"),visualContent:document.querySelector("#visualContent"),pageIndicators:document.querySelector("#pageIndicators"),prevButton:document.querySelector("#prevButton"),nextButton:document.querySelector("#nextButton"),container:document.querySelector("#container")}}function Qg(){Ze.forEach(n=>{const e=new Image;e.src=n.imageUrl})}function Zg(){Jg(),e_(),Qg(),Pa(),i_(),g.pageTotal&&(g.pageTotal.textContent=Ze.length)}function e_(){g.pageIndicators&&(g.pageIndicators.innerHTML="",Ze.forEach((n,e)=>{const t=document.createElement("button");t.className="indicator",t.setAttribute("aria-label",`Go to story ${e+1}`),t.innerHTML=`
    ...
    `,t.style.cssText=`
        ...
        gap: 8px;
        z-index: 10;
    `,e.parentElement.style.position="relative",e.parentElement.appendChild(t)),t.style.display="flex";const s=new Image;s.onload=function(){e.src=this.src,e.style.opacity="1",t.style.display="none"},s.onerror=function(){e.style.opacity="1",t.querySelector(".loading-text").textContent="載入失敗",t.querySelector(".loading-spinner").style.display="none",setTimeout(()=>{t.style.display="none"},2e3)},s.src=n.imageUrl,e.alt=`${n.title} - ${n.volunteer}`}t_(),g.scrollHint&&(se===0?g.scrollHint.classList.remove("hidden"):g.scrollHint.classList.add("hidden"))}function t_(){if(!g.pageIndicators)return;g.pageIndicators.querySelectorAll(".indicator").forEach((e,t)=>{t===se?e.classList.add("active"):e.classList.remove("active")})}function fr(n){if(dt||dr)return;const e=Math.max(0,Math.min(Ze.length-1,n));e!==se&&(dt=!0,g.storyContent&&g.storyContent.classList.add("animating"),g.visualContent&&g.visualContent.classList.add("animating"),setTimeout(()=>{se=e,Pa(),setTimeout(()=>{g.storyContent&&g.storyContent.classList.remove("animating"),g.visualContent&&g.visualContent.classList.remove("animating"),dt=!1},100)},300))}function Fn(){const n=se===0?Ze.length-1:se-1;fr(n)}function Wn(){const n=se===Ze.length-1?0:se+1;fr(n)}function _s(n){const e=document.getElementById("lightbox");if(!e||!e.classList.contains("active"))return;n.preventDefault(),n.stopPropagation();const t=Date.now();t-$i<500||dt||($i=t,n.deltaY>0?Wn():Fn())}function n_(n){const e=document.getElementById("lightbox");if(!(!e||!e.classList.contains("active"))&&!(dt||dr))switch(n.key){case"ArrowLeft":case"ArrowUp":n.preventDefault(),Fn();break;case"ArrowRight":case"ArrowDown":n.preventDefault(),Wn();break;case"Escape":n.preventDefault(),hr();break}}function s_(n){Da=n.touches[0].clientY}function r_(n){if(dt||dr)return;const e=n.changedTouches[0].clientY,t=Da-e;Math.abs(t)>50&&(t>0?Wn():Fn())}function i_(){g.prevButton&&g.prevButton.addEventListener("click",Fn),g.nextButton&&g.nextButton.addEventListener("click",Wn),window.addEventListener("wheel",_s,{passive:!1}),document.addEventListener("wheel",_s,{passive:!1}),g.container&&g.container.addEventListener("wheel",_s,{passive:!1}),document.addEventListener("keydown",n_),g.container&&(g.container.addEventListener("touchstart",s_,{passive:!0}),g.container.addEventListener("touchend",r_,{passive:!0}));const n=document.getElementById("lightbox");n&&n.addEventListener("click",function(e){e.target===this&&hr()})}window.openLightbox=Xg;window.closeLightbox=hr;function x(n,e="info",t="通知"){const s=document.querySelector("#authToast"),r=document.querySelector("#toastIcon"),i=document.querySelector("#toastTitle"),o=document.querySelector("#toastBody"),a=s.querySelector(".toast-header");switch(i.textContent=t,o.textContent=n,a.className="toast-header",r.className="me-2",e){case"success":a.classList.add("bg-success","text-white"),r.classList.add("fas","fa-check-circle","text-white");break;case"error":a.classList.add("bg-danger","text-white"),r.classList.add("fas","fa-exclamation-circle","text-white");break;case"warning":a.classList.add("bg-warning","text-dark"),r.classList.add("fas","fa-exclamation-triangle","text-dark");break;default:a.classList.add("bg-primary","text-white"),r.classList.add("fas","fa-info-circle","text-white")}new bootstrap.Toast(s,{autohide:!0,delay:e==="error"?5e3:3e3}).show()}function o_(){Dm(At,n=>{console.log("認證狀態變化:",n),a_(!!n,n)})}function a_(n,e=null){const t=document.getElementById("mobileLoginBtn"),s=document.getElementById("mobileMemberBtn"),r=document.getElementById("desktopLoginBtn"),i=document.getElementById("desktopMemberBtn"),o=document.querySelector("#mobileLogoutBtn"),a=document.querySelectorAll(".member-only-item");console.log("更新UI，登入狀態:",n),n?(t&&t.classList.add("d-none"),s&&s.classList.remove("d-none"),r&&r.classList.add("d-none"),i&&i.classList.remove("d-none"),o&&(o.className="btn btn-secondaryL fw-semibold rounded-pill w-100",o.innerHTML='<i class="fas fa-sign-out-alt me-2"></i>登出',o.onclick=ka),a.forEach(c=>{c.classList.remove("d-none")}),e&&e.displayName&&document.querySelectorAll(".user-display-name").forEach(l=>{l.textContent=e.displayName}),console.log("UI已切換為登入狀態")):(t&&t.classList.remove("d-none"),s&&s.classList.add("d-none"),r&&r.classList.remove("d-none"),i&&i.classList.add("d-none"),o&&(o.className="btn btn-secondaryL fw-semibold rounded-pill w-100",o.innerHTML="登入/註冊",o.onclick=Ra),a.forEach(c=>{c.classList.add("d-none")}),console.log("UI已切換為未登入狀態"))}function c_(n,e){if(e.classList.contains("logout-item"))return;n.preventDefault(),e.closest(".member-dropdown").querySelectorAll(".dropdown-item:not(.logout-item)").forEach(r=>{r.classList.remove("selected","active")}),e.classList.add("selected"),console.log("選中項目:",e.textContent.trim())}async function ka(){if(confirm("確定要登出嗎？"))try{await Pm(At),x("已成功登出","success","登出成功"),console.log("登出成功")}catch(n){console.error("登出失敗:",n),x("登出時發生錯誤","error","登出失敗")}}function Ra(){const n=new bootstrap.Modal(document.querySelector("#loginModal"));document.body.classList.add("modal-open-custom"),n.show()}function l_(n){const e=document.querySelector(`#${n}`),t=document.querySelector(`#${n}Icon`);e.type==="password"?(e.type="text",t.classList.remove("fa-eye"),t.classList.add("fa-eye-slash")):(e.type="password",t.classList.remove("fa-eye-slash"),t.classList.add("fa-eye"))}async function Es(){console.log("Google 登入被點擊");try{const n=await Yg();console.log("Google 登入成功:",n.user),x("Google 登入成功！歡迎回來","success","登入成功");const e=bootstrap.Modal.getInstance(document.querySelector("#loginModal"));e&&e.hide()}catch(n){console.error("Google 登入失敗:",n);let e="Google 登入失敗";switch(n.code){case"auth/popup-closed-by-user":e="登入窗口已關閉，請重新嘗試";break;case"auth/popup-blocked":e="彈出窗口被阻擋，請允許彈出窗口後重試";break;default:e=`Google 登入失敗：${n.message}`}x(e,"error","登入失敗")}}async function vs(){console.log("GitHub 登入被點擊");try{const n=await Kg();console.log("GitHub 登入成功:",n.user),x("GitHub 登入成功！歡迎回來","success","登入成功");const e=bootstrap.Modal.getInstance(document.querySelector("#loginModal"));e&&e.hide()}catch(n){console.error("GitHub 登入失敗:",n);let e="GitHub 登入失敗";switch(n.code){case"auth/popup-closed-by-user":e="登入窗口已關閉，請重新嘗試";break;case"auth/popup-blocked":e="彈出窗口被阻擋，請允許彈出窗口後重試";break;default:e=`GitHub 登入失敗：${n.message}`}x(e,"error","登入失敗")}}window.openLoginModal=Ra;window.togglePassword=l_;window.handleLogout=ka;document.addEventListener("DOMContentLoaded",function(){console.log("DOM 載入完成"),o_();const n=document.querySelector("#loginModal"),e=document.body;n.addEventListener("show.bs.modal",function(){document.querySelectorAll("body > *:not(.modal):not(.modal-backdrop)").forEach(c=>{c.style.filter="blur(15px)",c.style.transition="filter 0.3s ease"}),setTimeout(()=>{const c=document.querySelector(".modal-backdrop");c&&(c.style.backgroundColor="rgba(0, 0, 0, 0.3)")},100)}),n.addEventListener("hide.bs.modal",function(){document.querySelectorAll("body > *").forEach(c=>{c.style.filter="",c.style.transition=""}),e.classList.remove("modal-open-custom")}),document.querySelector("#loginForm").addEventListener("submit",async function(a){a.preventDefault();const c=new FormData(this),l=c.get("email"),u=c.get("password");if(!l||!u){x("請輸入電子郵件和密碼","warning","輸入不完整");return}try{const f=await Gg(l,u);console.log("登入成功:",f.user),x("登入成功！歡迎回來","success","登入成功");const d=bootstrap.Modal.getInstance(n);d&&d.hide()}catch(f){console.error("登入失敗:",f);let d="登入失敗";switch(f.code){case"auth/user-not-found":d="找不到此帳號，請先註冊或檢查 Email 是否正確";break;case"auth/wrong-password":case"auth/invalid-credential":d="密碼錯誤或帳號不存在，請檢查登入資訊";break;case"auth/invalid-email":d="請輸入有效的電子郵件地址";break;default:d=`登入失敗：${f.message}`}x(d,"error","登入失敗")}}),document.querySelector("#registerForm").addEventListener("submit",async function(a){a.preventDefault();const c=new FormData(this),l=c.get("name"),u=c.get("email"),f=c.get("password"),d=c.get("confirmPassword");if(!l||!u||!f||!d){x("請填寫所有必填欄位","warning","輸入不完整");return}if(f!==d){x("密碼和確認密碼不一致","warning","密碼不符");return}if(f.length<6){x("密碼至少需要6個字元","warning","密碼太短");return}try{const p=await zg(u,f);console.log("註冊成功:",p.user),x("註冊成功！現在可以使用此帳號登入","success","註冊成功");const E=bootstrap.Modal.getInstance(n);E&&E.hide(),this.reset()}catch(p){console.error("註冊失敗:",p);let E="註冊失敗";switch(p.code){case"auth/email-already-in-use":E="此電子郵件已被註冊，請使用其他 Email 或嘗試登入";break;case"auth/invalid-email":E="請輸入有效的電子郵件地址";break;case"auth/weak-password":E="密碼強度不足，請使用更複雜的密碼（至少包含字母和數字）";break;default:E=`註冊失敗：${p.message}`}x(E,"error","註冊失敗")}});const t=document.querySelector("#googleLoginBtn"),s=document.querySelector("#githubLoginBtn"),r=document.querySelector("#googleRegisterBtn"),i=document.querySelector("#githubRegisterBtn");t&&(t.addEventListener("click",Es),console.log("Google 登入按鈕事件已綁定")),s&&(s.addEventListener("click",vs),console.log("GitHub 登入按鈕事件已綁定")),r&&(r.addEventListener("click",Es),console.log("Google 註冊按鈕事件已綁定")),i&&(i.addEventListener("click",vs),console.log("GitHub 註冊按鈕事件已綁定")),!t&&!r&&(console.log("使用備用方案綁定 Google 按鈕"),document.querySelectorAll(".social-btn .fa-google").forEach((c,l)=>{const u=c.closest("button");u&&(u.addEventListener("click",Es),console.log(`Google 按鈕 ${l+1} 事件已綁定`))})),!s&&!i&&(console.log("使用備用方案綁定 GitHub 按鈕"),document.querySelectorAll(".social-btn .fa-github").forEach((c,l)=>{const u=c.closest("button");u&&(u.addEventListener("click",vs),console.log(`GitHub 按鈕 ${l+1} 事件已綁定`))}));function o(){document.querySelectorAll(".member-dropdown").forEach(c=>{c.querySelectorAll(".dropdown-item:not(.logout-item)").forEach(u=>{u.addEventListener("click",function(f){c_(f,this)})})})}o()});function u_(){const n=document.querySelector("#mobileDropdown"),e=document.querySelector("#hamburgerIcon"),t=document.body;n.classList.toggle("show"),n.classList.contains("show")?(e.className="fa-solid fa-xmark text-natural-700 hamburger-icon active",t.classList.add("mobile-menu-open"),d_()):(e.className="fa-solid fa-bars text-natural-700 hamburger-icon",t.classList.remove("mobile-menu-open"),$a())}function Ma(){const n=document.querySelector("#mobileDropdown"),e=document.querySelector("#hamburgerIcon"),t=document.body;n.classList.remove("show"),e.className="fa-solid fa-bars text-natural-700 hamburger-icon",t.classList.remove("mobile-menu-open"),$a()}function d_(){const n=document.documentElement;n.requestFullscreen?n.requestFullscreen().catch(()=>{}):n.webkitRequestFullscreen?n.webkitRequestFullscreen():n.msRequestFullscreen&&n.msRequestFullscreen(),screen.orientation&&screen.orientation.lock&&screen.orientation.lock("portrait").catch(()=>{})}function $a(){!document.fullscreenElement&&!document.webkitFullscreenElement&&!document.msFullscreenElement||(document.exitFullscreen?document.exitFullscreen().catch(()=>{}):document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen())}window.toggleMobileDropdown=u_;window.closeMobileDropdown=Ma;document.addEventListener("fullscreenchange",pr);document.addEventListener("webkitfullscreenchange",pr);document.addEventListener("msfullscreenchange",pr);function pr(){const n=document.querySelector("#mobileDropdown");!document.fullscreenElement&&!document.webkitFullscreenElement&&!document.msFullscreenElement&&n&&n.classList.contains("show")&&Ma()}window.bootstrap=Fh;
